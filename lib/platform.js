...
function buildPriceRatio(historicalTokens, historicalCost, totalTokens, totalCost, todayTokens, todayCost) {
...
export async function fetchPlatformSnapshot(token) {
    ...
    return {
        ...
        price_ratio: buildPriceRatio(historyAmountAgg.tokens, historyCostAgg.total, sinceAmountAgg.tokens, sinceCostAgg.total, currentAmount.tokens, currentCost.total),
    };
}
