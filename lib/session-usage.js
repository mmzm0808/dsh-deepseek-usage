...
function foldEvents(events, byProviderModel, start, end, granularity) {
    let currentProvider;
    let currentModel;
 ...
 */
export async function fetchSessionModelUsageSeries(persistence, sessions, startDate, endDate, granularity) {
