  ...
  `;
			...
			const render = (state) => {
				...
				if (modelData) {
					...
					stateFields.r0Total.title = modelData.has_history ? `8月17日起累计 A2/A1 = ${modelData.a2_total !== null ? toScientific(modelData.a2_total) : "--"} / ${toScientific(modelData.a1)}` : `无涨价前历史，使用默认 A1 = ${toScientific(modelData.a1)}`;
					...
					stateFields.r0Today.title = modelData.has_history ? `今日 A2/A1 = ${modelData.a2_today !== null ? toScientific(modelData.a2_today) : "--"} / ${toScientific(modelData.a1)}` : `无涨价前历史，使用默认 A1 = ${toScientific(modelData.a1)}`;
				} else {
