  ...
  `;
			...
			const render = (state) => {
				...
				if (modelData) {
					...
					stateFields.r0Total.title = modelData.has_history ? `8月17日起累计 A2/A1 = ${modelData.a2_total?.toFixed(8)} / ${modelData.a1.toFixed(8)}` : `无涨价前历史，使用默认 A1 = ${modelData.a1.toFixed(8)}`;
					...
					stateFields.r0Today.title = modelData.has_history ? `今日 A2/A1 = ${modelData.a2_today?.toFixed(8)} / ${modelData.a1.toFixed(8)}` : `无涨价前历史，使用默认 A1 = ${modelData.a1.toFixed(8)}`;
				} else {
