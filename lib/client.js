window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region src/client/VentusFallbackGroupCard.ts
		/**
		...
		*/
		...
		const bodyStyle$1 = { paddingTop: "6px" };
		/** Render a Ventus series group that hosts our settings card. */
		function VentusFallbackGroupCard(props) {
			const [open, setOpen] = (0, react.useState)(false);
			return (0, react.createElement)("li", { style: groupStyle }, (0, react.createElement)("div", {
				style: headerStyle,
				role: "button",
				tabIndex: 0,
				...
				fontWeight: "700",
				fontSize: "14px"
			} }, "Ventus 插件"), (0, react.createElement)("span", { style: { fontSize: "12px" } }, open ? "▾" : "▸")), open ? (0, react.createElement)("div", { style: bodyStyle$1 }, props.renderSlot("ventus.plugin.item", {})) : null);
		}
		//#endregion
